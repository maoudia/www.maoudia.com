...
== Requirements
1. https://gohugo.io/getting-started/installing/[Hugo] (0.152.x)
...
[source,shell]
----
hugo server --buildDrafts --buildExpired --buildFuture  --templateMetrics --templateMetricsHints --logLevel debug
----
